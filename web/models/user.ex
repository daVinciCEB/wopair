defmodule WorkoutDemo.User do
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:name, :email, :password_hash, :description, :location, :latitude, :longitude])
    |> validate_required([:name, :email, :password_hash, :description, :location, :latitude, :longitude])
