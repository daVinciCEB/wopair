defmodule WorkoutDemo.RegistrationControllerTest do
  ...
  @valid_registration_attrs %{name: "Coby Benveniste", email: "coby.benveniste@gmail.com", verified: true, password: "thisisapassword", description: "some content", latitude: 76.5, longitude: 120.5, radius: 1000}
